		   	...
		   	<table  class="table table-success  text-center" >
		        ...
		        <tbody>
				   ...
				   for(AlumnoCurso ac:lst){
		            ...
		            <tr>
		            	<td class="text-center"	><input type="text" name="txtId2" class="span1 m-wrap text-center" readonly value="<%=ac.getId() %>"  /></td>
...
<!-- 		            	<td class="text-center"><input type="text" name="txtNotaAlumno" class="span1 m-wrap text-center" value="0"  /></td> -->		       			
		                 <td class="text-center">
							  ...
							  <select class="form-control-sm" name="nota2" >
        ...
        <div class="widget-content sm">
          <div  class="form-horizontal">
            <div class="form-actions">
	              <button type="submit" class="btn btn-info btn-block btn-sm" value="btnCargarSegunda" name="accion">CONFIRMAR SEGUNDA EVALUACION</button>
	        </div>			                
		  </div>
		</div>		
		</div>
